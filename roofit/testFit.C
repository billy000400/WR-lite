...
void testFit(std::string filePath)
{
  ...
  ee2CBPulls.plotOn(ee2CBPullFrame, Binning(40));
  mumu2CBPulls.plotOn(mumu2CBPullFrame, Binning(40));
  eeCBPulls.plotOn(eeCBPullFrame, Binning(40));
  mumuCBPulls.plotOn(mumuCBPullFrame, Binning(40));
