...
void testFit()
{
  ...
  // Draw ntuples
  RooPlot *frame1 = WR_RecoMass.frame(Title("WR Reco Mass"), AxisLabel("Number:Reco Mass (GeV)"));
  ds.plotOn(frame1, Binning(32));

  RooPlot *frame2 = N_RecoMass.frame(Title("N Reco Mass"), AxisLabel("Number:Reco Mass (GeV)"));
