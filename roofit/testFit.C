...
void testFit(std::string filePath)
{
  ...
  RooRealVar n_ee("n_ee","n for ee", 2.0, 0.0, 150.0);
  ...
  RooRealVar n_mumu("n_mumu","n for mumu", 2.0, 0.0, 150.0);
...
RooAddPdf* DoubleCB(RooRealVar* rrv_x, double mean)
{
  ...
  RooRealVar* rrv_normalization_CB_I = new RooRealVar("rrv_normalization_CB_I", "rrv_normalization_CB_I", 2, 0., 150.);
