...
void testFit_ExpCB(std::string filePath)
{
  ...
  RooExpCBShape* WR_ee_doubleCB = ExpCB_init(WR_RecoMass_ee, WRGenMean, "eejj");
  RooExpCBShape* WR_mumu_doubleCB = ExpCB_init(WR_RecoMass_mumu, WRGenMean, "mumujj");
  ...
  //// Plot on frames
  // plot data on frames
  ds_WR_RecoMass_ee.plotOn(eeFrame_doubleCB, Binning(100), DataError(RooAbsData::SumW2));
  ds_WR_RecoMass_mumu.plotOn(mumuFrame_doubleCB, Binning(100), DataError(RooAbsData::SumW2));
