...
void testFit_ExpmCB(std::string filePath)
{
  ...
  RooExpCBShape* WR_ee_ExpCB = ExpCB_init(WR_RecoMass_ee, WRGenMean, "eejj");
  RooExpmCB* WR_mumu_ExpmCB = ExpmCB_init(WR_RecoMass_mumu, WRGenMean, "mumujj");


  //// fit distribution to data
  RooFitResult *r1 = WR_ee_ExpCB->fitTo(ds_WR_RecoMass_ee, Save(), Range(WRGenMean*0.45,WRGenMean*1.45));
  ...
  RooPlot *eeFrame_ExpCB = WR_RecoMass_ee->frame(Title("eejj ExpCB"));
