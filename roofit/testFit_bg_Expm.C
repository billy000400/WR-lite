...
void testFit_bg_Expm()
{
  ...
  //// fit model
  RooFitResult *r_mm = model_mm->fitTo(ds_bg_mumujj, Save(), SumW2Error(kTRUE), Range(600, 3000), Strategy(2));
  RooFitResult *r_ee = model_ee->fitTo(ds_bg_eejj, Save(), SumW2Error(kTRUE), Range(600, 3000), Strategy(2));
