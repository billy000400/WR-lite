...
void HE_fit_DoubleCB()
{
  // importing ntuples into RooDataSet
  RooRealVar* WR_RecoMass = new RooRealVar("WR_RecoMass", "WR_RecoMass", 0, 15000);

  RooDataSet ds1("ds1", "ds1",
                RooArgSet(*WR_RecoMass, *N_RecoMass_Match, *N_RecoMass_NN),
                ImportFromFile("../WR6000_N3000/out_WR6000N3000_1.root","analysis/WR_N_RecoMass"));
  ...
  RooRealVar* rrv_mean_CB = new RooRealVar("rrv_mean_CB", "rrv_mean_CB", 6000, 5000, 7000);
  ...
  RooFitResult *r = WR_pdf->fitTo(ds1, Save(), Range(2500,10000));
  r->Print();
