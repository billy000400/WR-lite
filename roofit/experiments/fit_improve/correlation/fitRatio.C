...
void fitRatio(std::string filePath)
{
  ...
  std::ofstream result1("results_fitRatio_ee/"+filePath+".txt");
  std::ofstream result2("results_fitRatio_mumu/"+filePath+".txt");
  ...
  std::string plot_file_prefix = "plots_fitRatio/";
