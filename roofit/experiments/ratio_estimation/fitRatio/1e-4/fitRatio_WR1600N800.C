...
void fitRatio_WR1600N800()
{
  ...
  for (int i=0; i<sampleNum; i++){
    ...
    // add distribution
    RooRealVar *fsig_mumu = new RooRealVar("fsig_mumu", "signal fraction mumujj", 7e-5, 5e-5, 15e-5);
    RooRealVar *fsig_ee = new RooRealVar("fsig_ee", "signal fraction eejj", 7e-5, 5e-5, 15e-5);
