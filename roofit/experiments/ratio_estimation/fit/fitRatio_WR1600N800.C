...
void fitRatio_WR1600N800()
{
  ...
  // add distribution
  RooRealVar *fsig_mumu = new RooRealVar("fsig_mumu", "signal fraction mumujj", 5e-3, 1e-4, 1e-2);
  RooRealVar *fsig_ee = new RooRealVar("fsig_ee", "signal fraction eejj", 5e-3, 1e-4, 1e-2);
