...
void testFit_rightCB()
{
  ...
  RooRealVar m0("m0","m0",2000, 1800, 2200);
  RooRealVar sigma("sigma","sigma", 80, 5, 500);
  RooRealVar alpha("alpha", "alpha", -0.1, -250, 250);
  RooRealVar n("n","n", 0.1, -100, 100);
  ...
  gauss.fitTo(ds1, Range(500.0,2000.0));
