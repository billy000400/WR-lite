...
void extractHistos(TH1D ** oneDhistograms, TH2D ** twoDhistograms, std::string * oneDhistoNames, std::string * twoDhistoNames, std::string file, double xsec, int fileNumber, int oneDHistoCount, int twoDHistoCount, bool oneDmult, bool twoDmult ) {
	...
	for(int i = 1; i<= fileNumber; i++){
		...
		if(access( (file+std::to_string(i)+".root").c_str(), F_OK ) != -1){
			...
			if(f->GetDirectory("analysis")==0){
				std::cout << "Failed to access analysis directory"<< std::endl;
				continue;
			}
			TDirectory * d1 = f->GetDirectory("analysis");
			if(d1->GetDirectory("allEvents")==0){
				std::cout << "Failed to access allEvents directory"<< std::endl;
				continue;
			}
...
void extractMain(){
	...
	std::string files[43] = {"WR800_N200/out_WR800N200_",
							...
							"WR1000_N200/out_WR1000N200_",
							"WR1000_N400/out_WR1000N400_",
							"WR1000_N600/out_WR1000N600_",
							"WR1000_N800/out_WR1000N800_",
							"WR1000_N900/out_WR1000N900_",
							"WR1200_N400/out_WR1200N400_",
							"WR1200_N600/out_WR1200N600_",
							"WR1200_N800/out_WR1200N800_",
							"WR1200_N1000/out_WR1200N1000_",
							"WR1200_N1100/out_WR1200N1100_",
							"WR1400_N400/out_WR1400N400_",
							"WR1400_N600/out_WR1400N600_",
							"WR1400_N800/out_WR1400N800_",
							"WR1400_N1000/out_WR1400N1000_",
							"WR1400_N1200/out_WR1400N1200_",
							"WR1400_N1300/out_WR1400N1300_",
							"WR1600_N400/out_WR1600N400_",
							"WR1600_N600/out_WR1600N600_",
							"WR1600_N800/out_WR1600N800_",
							"WR1600_N1000/out_WR1600N1000_",
							"WR1600_N1200/out_WR1600N1200_",
							"WR1600_N1400/out_WR1600N1400_",
							"WR1600_N1500/out_WR1600N1500_",
							"WR1800_N400/out_WR1800N400_",
							"WR1800_N600/out_WR1800N600_",
							"WR1800_N800/out_WR1800N800_",
							"WR1800_N1000/out_WR1800N1000_",
							"WR1800_N1200/out_WR1800N1200_",
							"WR1800_N1400/out_WR1800N1400_",
							"WR1800_N1600/out_WR1800N1600_",
							"WR1800_N1700/out_WR1800N1700_",
							"WR2000_N600/out_WR2000N600_",
							"WR2000_N800/out_WR2000N800_",
							"WR2000_N1000/out_WR2000N1000_",
							"WR2000_N1200/out_WR2000N1200_",
	...
	for(int j = 15; j<16; j++){
		...
		extractHistos(oneDhistogramsReco, twoDhistogramsReco, oneDhistoNamesReco, twoDhistoNamesReco, files[j], xsec[j], fileNumber, oneDHistoRecoCount, twoDHistoRecoCount, true, true );
		//std::cout<<"b"<<std::endl;
		...
		extractHistos(oneDhistogramsGen, twoDhistogramsNN, oneDhistoNamesGen, twoDhistoNamesNN, files[j], xsec[j], fileNumber, oneDHistoGenCount, 0, true, true);
		std::cout<<"b"<<std::endl;
		for(int i =0; i<oneDHistoGenCount; i++){
			std::cout<<i<<std::endl;
			print1DHistos(oneDhistogramsGen[i], c, files[j], oneDhistoNamesGen[i]);
		}
		
		//Extract and print remaining 1-d histos and 2-d NN histos
		extractHistos(oneDhistogramsDiv, twoDhistogramsNN, oneDhistoNamesDiv, twoDhistoNamesNN, files[j], xsec[j], fileNumber, oneDHistoDivCount, twoDHistoNNCount, false, true );
