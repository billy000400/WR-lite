...
def main():
    ...
    np.save("../../python_analysis/data/DY_mumujjMassArray.npy", mumujjMassArray_new)
    np.save("../../python_analysis/data/DY_mumujjRowWeightArray.npy", mumujjRowWeightArray_new)
